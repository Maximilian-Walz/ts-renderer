  ...
  return (
    <div className="form-control indicator join join-horizontal self-end">
      ...
      <div className="relative mr-auto">
        {labelContained && !editing && <span className="label-text absolute bottom-0 top-0 self-center pl-6">{label}</span>}
        <input
          type="text"
          className={`input input-xs self-center border-none bg-gray-700 px-[25px] align-top hover:bg-gray-600 focus:outline-none ${editing && 'text-start'} ${!editing && (labelContained ? 'text-end' : 'text-start')}`}
          value={value}
